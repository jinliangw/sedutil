...
////////////////////////////////////////////////////////////////////////////////
{
    ...
    struct uidlist list2[] =
    {
		...
		{ { 0x00, 0x00, 0x00, 0x09, 0x00, 0x01, 0x00, 0x00 }, "Admin%u" },
		{ { 0x00, 0x00, 0x00, 0x09, 0x00, 0x03, 0x00, 0x00 }, "User%u" },
        { { 0x00, 0x00, 0x00, 0x0B, 0x00, 0x01, 0x00, 0x00 }, "C_PIN_Admin%u" },
        { { 0x00, 0x00, 0x00, 0x0B, 0x00, 0x03, 0x00, 0x00 }, "C_PIN_User%u" },
		{ { 0x00, 0x00, 0x08, 0x02, 0x00, 0x00, 0x00, 0x00 }, "Locking Range %u" },
		{ { 0x00, 0x00, 0x08, 0x02, 0x00, 0x03, 0x00, 0x00 }, "Locking Range %u" },
